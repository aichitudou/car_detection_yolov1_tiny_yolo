...
{
    char *train_images = "/home/john/dockerData/darknetv1/data/voc/2007_train.txt";
    char *backup_directory = "/home/john/dockerData/darknetv1/backup";
    srand(time(0));
    data_seed = time(0);
...
void validate_yolo(char *cfgfile, char *weightfile)
{
    ...
    list *plist = get_paths("/home/john/dockerData/darknetv1/data/voc/2007_test.txt");
